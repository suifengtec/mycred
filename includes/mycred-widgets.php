...
if ( ! class_exists( 'myCRED_Widget_Balance' ) ) :
	class myCRED_Widget_Balance extends WP_Widget {
		...
		function __construct() {
			...
			parent::__construct( 'mycred_widget_balance', sprintf( __( '(%s) My Balance', 'mycred' ), $name ), $widget_ops );
...
if ( ! class_exists( 'myCRED_Widget_Leaderboard' ) ) :
	class myCRED_Widget_Leaderboard extends WP_Widget {
		...
		function __construct() {
			...
			parent::__construct( 'mycred_widget_list', sprintf( __( '(%s) Leaderboard', 'mycred' ), $name ), $widget_ops );
...
if ( ! class_exists( 'myCRED_Widget_Wallet' ) ) :
	class myCRED_Widget_Wallet extends WP_Widget {
		...
		function __construct() {
			...
			parent::__construct( 'mycred_widget_wallet', sprintf( __( '(%s) Wallet', 'mycred' ), mycred_label( true ) ), $widget_ops );
